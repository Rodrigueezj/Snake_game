...
class Snake:
    ...
    def draw(self):
        for square in self.body:
            col, row = square
            pygame.draw.rect(surface, GREEN,(row * SQSIZE, col* SQSIZE,SQSIZE, SQSIZE))

    def erase(self):
        for square in self.body:
            col, row = square
            pygame.draw.rect(surface, BLACK,(row * SQSIZE, col* SQSIZE,SQSIZE, SQSIZE))
...
class Apple:
    ...
    def draw(self):
        pygame.draw.rect(surface, RED,(self.x * SQSIZE, self.y * SQSIZE,SQSIZE, SQSIZE))
